...
while ($true) {
    ...
    if ($aiMode) {
        ...
        try {
            # UTF-8 Charset එක Force කරලා Supabase Edge Function එක Invoke කිරීම
...
'@;
    // PowerShell එකට Script එක Plain Text එකක් විදිහට යැවීම
    res.setHeader('Content-Type', 'text/plain; charset=utf-8');
    return res.status(200).send(psScript);
  }

  // සාමාන්‍ය කෙනෙක් බ්‍රවුසර් (Chrome/Safari) එකෙන් ආවොත් නිල Vercel 404 පේජ් එක දෙනවා
